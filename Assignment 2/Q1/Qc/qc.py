...
def main():
    ...
    results3=pickle.load(open("results3.pickle","rb"))
    results4=pickle.load(open("results4.pickle","rb"))

    print("\nConfusion Matrix over the Algorithm: \n",results2)
    print("Confusion Matrix over the Random Prediction: \n",results3)
    print("Confusion Matrix over the Positive Assignment: \n",results4)
    print("\nClearly, Algorithm gives maximum value of trace of confusion matrix i.e maximum value of accuracy as compared to Random Prediction and Positive Assignment\n")
